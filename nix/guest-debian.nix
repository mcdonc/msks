...
let
  ...
  # and offline builds — pi, herdr, Claude Code — in
  # nix/agent-toolchain.nix, staged below the Debian way. One file
  # owns every pin; the NixOS image stages the same derivations
  # through its system profile.
