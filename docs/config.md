...
| `ssh_key_type`            | `MSKSD_SSH_KEY_TYPE`            | string | `ed25519`              | The identity type minted at create (#111): `ed25519` (the default, #138 — FIPS-approvable and accepted by every restricted ssh client), `ecdsa` (P-256), or `rsa` (3072-bit).                                                                                   |
